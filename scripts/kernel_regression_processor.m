...
methods
    ...
    function obj = kernel_regression_processor( sitecode, varargin )
        ...
        p.addParameter( 'daily_data', ...
            table([]), ...
            @( x ) isa( x, 'table' ) );
        p.addParameter( 'daily_data_already_processed', ...
            false, ...
            @islogical );
    ...
    % --------------------------------------------------
    function [obj, all_data] = get_kernel_regression_data( obj )
        
    end %get_kernel_regression_data
    
    % --------------------------------------------------
    function [obj, daily_data ] = get_daily_data ( obj )
...
%             t_min, t_max );
    ...
    function obj = get_site_config( obj )
